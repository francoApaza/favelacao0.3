...
<div class="form-signin">
  ...
  <div class="card m-3 mt-6">
    <div class="card-body sombra">       
      <form action="../../backend/api/user/redefinir.php" name="#" method="post"  class="needs-validation">
            ...
            <?php
              ...
              // if($_POST['email']!=""){
                $sql = "SELECT * FROM usuarios WHERE email='bianca@gmail.com'"; 
            ...
            <button type="submit" value="redefinir" class="btn btn-block boton" data-toggle="modal" data-target="#exampleModalCenter">Enviar</button>
            <!-- <p class="ou">OU</p> -->
      </form>
      <p> <a class="aLogin" href="./cadastro.php"> Criar nova conta? </a><br>
      <a class="aLogin" href="./login.php"> Voltar login </a></p>   
    </div>
  </div>
</div>
